<?php
  ...
  $res = mysql_query("SELECT * FROM noticias WHERE id_categoria = '$categoria_id' ".$where." AND id_noticia > '$id_noticia' ORDER BY id_noticia DESC");
...
<div class="col-md-12">
  <div class="alert alert-info alert-dismissable">
    ...
    <strong>Aviso!</strong> No momento não existem novas noticias para essa categoria ou site.
  </div>
</div>
<?php } ?>